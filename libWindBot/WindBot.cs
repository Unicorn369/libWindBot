...
namespace WindBot
{
    public class WindBot
    {
        ...
        public static void InitWindBot(string assetPath, string databasePath, string confPath)
        { InitAndroid(assetPath, databasePath, confPath); }
        ...
        public static void RunWindBot(string arg)
        { RunAndroid(arg); }
    ...
    public class Program
    {
        ...
        public static string getFile(string directory, string filename, string extension)
        {
        ...
        {
            string fullpath = getFile(directory, filename, extension);
